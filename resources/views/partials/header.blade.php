<div class="fixed top-0 left-0 right-0 z-50">
    ...
    <div class="h-full w-full">
        <!-- Code block starts -->
        <nav class="w-full bg-transparent hidden xl:block">
            <div class="container px-6 h-16 flex justify-center items-center lg:items-stretch mx-auto">
                <div class="flex items-center">
                    <div class="hidden xl:flex items-center h-full">
                        <a href="javascript:void(0)"
                            class="focus:outline-none border-b-2 border-transparent focus:border-indigo-700 cursor-pointer h-full flex items-center text-sm text-gray-700 hover:text-indigo-700 focus:text-indigo-700 tracking-normal transition duration-150 ease-in-out">
                            <span class="mr-2">
                        ...
                        <a href="javascript:void(0)"
                            class="focus:outline-none border-b-2 border-transparent focus:border-indigo-700 focus:text-indigo-700 cursor-pointer h-full flex items-center text-sm hover:text-indigo-700 text-gray-800 mx-10 tracking-normal transition duration-150 ease-in-out">
                            <span class="mr-2">
                        ...
                        <button class="mx-10 flex items-center">
                            <img src="https://tuk-cdn.s3.amazonaws.com/can-uploader/left-aligned-with-icons-svg1.svg"
                                alt="logo" />
                            <h3
                                class="text-base text-gray-800 font-bold tracking-normal leading-tight mx-3 hidden lg:block">
                                The North</h3>
                        </button>
                        <a href="javascript:void(0)"
                            class="focus:outline-none border-b-2 border-transparent focus:border-indigo-700 focus:text-indigo-700 cursor-pointer h-full flex items-center text-sm hover:text-indigo-700 text-gray-800 mr-10 tracking-normal transition duration-150 ease-in-out">
                            <span class="mr-2">
                        ...
                        <a href="javascript:void(0)"
                            class="focus:outline-none border-b-2 border-transparent focus:border-indigo-700 focus:text-indigo-700 cursor-pointer h-full flex items-center text-sm hover:text-indigo-700 text-gray-800 tracking-normal transition duration-150 ease-in-out">
                            <span class="mr-2">
                ...
                <div class="flex items-center xl:hidden">
                    <ul
                        ...
                        <li
                            class="flex md:hidden cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-2 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-grid"
                                    width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5"
                        ...
                        <li class="flex md:hidden flex-col cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none flex justify-center"
                            ...
                            <ul class="ml-6 mt-1 hidden">
                                <li
                                    class="cursor-pointer text-gray-600 text-xs leading-3 tracking-normal py-2 hover:bg-indigo-700 hover:text-gray-800 px-3 font-normal">
                                    Landing Pages</li>
                                <li
                                    class="cursor-pointer text-gray-600 text-xs leading-3 tracking-normal py-2 hover:bg-indigo-700 hover:text-gray-800 px-3 font-normal">
                                    Templates</li>
                                <li
                                    class="cursor-pointer text-gray-600 text-xs leading-3 tracking-normal pt-2 hover:bg-indigo-700 hover:text-gray-800 px-3 font-normal">
                                    Components</li>
                            </ul>
                        </li>
                        <li
                            class="flex md:hidden cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 flex items-center focus:text-indigo-700 focus:outline-none">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-compass"
                                width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z"></path>
                        ...
                        <li class="border-b border-gray-300 flex md:hidden flex-col cursor-pointer text-gray-600 text-sm leading-3 tracking-normal pt-2 pb-4 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none flex justify-center"
                            onclick="dropdownHandler(this)">
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-code"
                                    width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5"
            ...
            <div class="py-4 px-6 w-full flex xl:hidden justify-between items-center bg-white fixed top-0 z-40">
                ...
                <div>
                    <button id="menu" aria-label="open menu"
                        class="focus:outline-none rounded-md focus:ring-2 focus:ring-gray-700 text-gray-800"
                        onclick="sidebarHandler(true)">
                        <img src="https://tuk-cdn.s3.amazonaws.com/can-uploader/left-aligned-with-icons-svg3.svg"
                            alt="menu" />
                    </button>
                </div>
            </div>
                                    ...
                                    <div class="flex items-center justify-between w-full">
                                        <div class="flex items-center">
                                            <img src="https://tuk-cdn.s3.amazonaws.com/can-uploader/left-aligned-with-icons-svg2.svg"
                                                alt="logo" />
                                            <p tabindex="0"
                                                class="focus:outline-none text-base md:text-2xl text-gray-800 ml-3">The
                                                North</p>
                                        </div>
                            ...
                            <div class="w-full pt-4">
                                <div class="flex justify-center mb-4 w-full">
                                    <div class="relative w-full">
                                        ...
                                        <input
                                            class="focus:ring-2 focus:ring-gray-700 bg-gray-100 focus:outline-none rounded w-full text-sm text-gray-500 pl-10 py-2"
                                    ...
                                    <div class="w-full flex items-center justify-between pt-1">
                                        <div class="flex items-center">
                                            <img alt="profile-pic"
                                                ...
                                                tabindex="0" class="focus:outline-none w-8 h-8 rounded-md" />
